...
const RescueForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      try {
        ...
        const response = await fetch(`${ BASE_URL }/rform`, {
          method: 'POST',
          body: formDataToSend,
        });

        if (response.ok) {
          Swal.fire('Rescue Form submitted successfully', '', 'success');
          setFormData({
            name: '',
            phoneNumber: '',
            email: '',
  ...
  return (
    <div className='rescue' style={{ paddingLeft: '630px' }}>
      <div className="cruelty-form-container">
        <div className="container2">
          <form onSubmit={handleSubmit}>
            <h1 style={{ textAlign: 'center' }}>Rescue Form</h1>
            <hr />
            <div className="container2">
            ...
            <label>
              Please describe in detail about the nature of animal rescue.
              <textarea
                name="description"
